...
p2 = Package.create!(classification: 'Premium', description: 'Access to conversations with high-level persons of interest (Professors, Managers, CEOs, etc), tailored language aids (chat bots, tutoring, voice-to-text), and tests for language proficiency of employees and prospective employees', price: 4.99)
