module MessagesHelper
  ...
  def message_convert_level_to_img(message)
    ...
    if message.sender.language == "Spanish"
      image_tag('spain-flag-circular.png', :style => "-webkit-filter: grayscale(#{filtered});", alt: 'Spanish')
    elsif message.sender.language == "Italian"
      image_tag('italy-flag-circular.png', :style => "-webkit-filter: grayscale(#{filtered});", alt: 'Italian')
    elsif message.sender.language == "German"
      image_tag('germany-flag-circular.png', :style => "-webkit-filter: grayscale(#{filtered});", alt: 'German')
      ...
      image_tag('france-flag-circular.png', :style => "-webkit-filter: grayscale(#{filtered});", alt: 'French')
    end
  end
